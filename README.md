...
## Clone and Run Locally (full steps)

1. Clone the repository:

```bash
git clone https://github.com/darshancs30/Real-Time-Industry-Insight-Strategic-Intelligence-System.git
cd Real-Time_Industry_Insights_and_Strategic_Intelligence_System
```
...
- The backend serves API endpoints at `http://localhost:8000`.
- The frontend will run on `http://localhost:3000` by default.
- Do not commit `frontend/build/` — it's git-ignored and generated by `npm run build`.
